---
title: "Edit an Onsite Sponsored Products Campaign"
sidebar_position: 2
---
...
You'll land on the selected campaign page, where you will find the Line Items and other campaign settings as shown in the screenshot. 

From the left panel, select Campaign Settings. 

You’re now on your campaign editing page, where you can modify:  
...
To edit any of these fields mentioned above, click on the respective icon.
...
If switching from capped to uncapped, select Uncapped to spend freely from the available funds of the balance linked to the campaign. 

If editing your capped campaign budget, choose Increase By or Decrease By and enter the amount to add to or remove from your remaining budget. You can mark the New Remaining Budget checkbox to make sure the budget corresponds to the amount you want your campaign to spend.

Campaign Pacing 
You can set pacing at the campaign level. You have the option to set a monthly or daily cap. If you set a cap at the campaign level, the campaign will stop spending once the line items under that campaign reach the amount specified in the cap.
...
Attribution is the process of identifying which marketing touchpoints and actions are responsible for driving a customer to make a purchase or take a desired action. 
You can edit your attribution settings by changing the Lookback Window and/or the Product Match for both Post-Click and Post-View.
To change your lookback window: 
