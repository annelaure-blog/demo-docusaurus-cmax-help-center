...
Note: Budget caps set at the campaign level will take precedence over a cap set at the line item level. 
...
Important: If your campaign is optimized towards the Revenue Optimizer or the Conversion Optimizer, allow the campaign to run for two weeks before making optimization changes. Similarly, once changes are made, allow 7-10 days for the engine to adjust. 
