---
title: "Create an Onsite Sponsored Products Campaign"
sidebar_position: 1
---
...
Campaigns in Commerce Max serve as the foundation for your advertising strategy and are one of the core pillars of the platform. 

A campaign is characterized by primary factors: name, budget, and attribution model. 

Each campaign consists of one or more line items, which group your ads by retailer, dates, creative, SKUs, and targeting. 

Sponsored Products in Commerce Max are bought via a 1st price CPC auction. 

You can choose the minimum and maximum bid you are willing to pay every time a shopper engages with your ad.
...
The Post-View lookback window cannot be greater than the Post-Click lookback window. 
...
For step-by-step instructions, please see Create a Sponsored Products Campaign.

Attribution Settings 
By default, your campaign uses: 

30-day post-click attribution (for same product and same category sales) 

1-day post-view attribution (for same product sales) 
We recommend keeping these settings to accurately measure performance.
To learn more, please see Campaign Attribution Settings. 

Budget Capping 
You can set a monthly or daily budget cap. For daily budgets, choose:
...
Balance Setup 
Ask your Criteo representative to assign your signed IO (insertion order) budgets. Once added, you can link them directly to your campaign.
...
Reach out to your Criteo representative for help 
To learn more, please see Product Selection.  
By following these steps, you’ll be set up for a successful campaign launch.
