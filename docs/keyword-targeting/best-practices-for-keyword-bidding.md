---
title: "Best Practices for Keyword Bidding"
sidebar_position: 5
---

## Best practices for Keyword Bidding

This guide explains how to use keyword mapping strategies - whitelisting, blacklisting, and bidding to better control how and where your Sponsored Products appear in search results. By leveraging keyword bidding alongside Criteo’s automated optimizers, you can fine-tune your strategies to prioritize high-value search terms, boost visibility on branded or seasonal keywords, and adjust bids based on performance insights.
...
Note: Bear in mind that if you want to add, negate, or adjust keyword bids at the individual product level, you will need to set up separate line items by product.
...
Note: Instead of setting manual bids for each keyword in your line item, it is recommended to rely primarily on your line item’s chosen automated optimization model to remove the guesswork and heavy-lifting of setting bids to meet your campaign and business objectives. 
...
Important: Please be aware that the Keyword Model will continuously append new search terms to your line item. More information on how these associations are made can be found here.
...
Example: Perhaps the primary KPI for your campaign is sales volume and ROAS, and you have opted to use Revenue Optimizer. However, during the winter holiday season, you want to recruit new customers higher up the purchase funnel.  
In this case, you may want to implement keyword bids to increase paid presence on seasonal terms (Example: gifts or stocking stuffers) that may not typically drive the largest sales volume or efficiency (and therefore, wouldn’t necessarily be prioritized by the Revenue optimizer), but are likely to get high traffic during this time frame.
