---
title: "About Negative Keyword Targeting"
sidebar_position: 3
---
...
Important: Any adjustments you make to your keyword targeting will NOT impact how your products appear on a retailer page organically. Keyword targeting will only impact the placements your sponsored ads appear in and has no impact on how a retailer chooses which products to return organically.
...
Men’s shoes 
Men shoes 
Blue men’s shoes Mens shoe size 9 
Shoes 
Boy’s shoes 
...
Mens shoe size 9 
 
Important: Misspellings and typos will not be captured by the Broad Match tool. If you want to exclude typos, we suggest you enter any and all misspellings you want to exclude in the negative exact match keyword tool.
...
Negative keywords will be applied to your line item within 15-30 minutes.  
...
Keywords are not case-sensitive. Additionally, special characters are permitted but may be automatically parsed. 

Duplicate entries will be automatically de-duplicated. 

The same keyword entered in both match-type text boxes will be considered as two separate keywords. For example, “remote control” in the Broad Match textbox and “remote control” in the Exact Match textbox are counted as two keywords. 
